        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <?php 
                    $counter = 1;
                    $qurey = "Select* from student_result_sem3 where id='". $_SESSION['admin_id']."'";
              ...
              <div class='row'>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <td>Computer Networks</td> 
                    <td><?php echo $row['computer_networks_theory_cie'];?></td>
                    <td><?php echo $row['computer_networks_theory_ese'];?></td>
                    
                    <td><?php echo $row['total_grade_3'];?></td>
                   
                    <td><?php echo $row['computer_networks_practical_cie'];?></td>
                    <td><?php echo $row['computer_networks_practical_ese'];?></td>
                  ...
                  <tr>
                  <td>Statistics</td> 
                    <td><?php echo $row['statistics_theory_cie'];?></td>
                    <td><?php echo $row['statistics_theory_ese'];?></td>
                    ...
                    <td>-</td>
                    <td>-</td>
                    <td><?php echo $row['subject_grade_1']; ?></td>
                    
                    
                  </tr>
                  <tr>
                  <td>Enviromental Studies</td> 
                    <td><?php echo $row['enviromentalstudies_theory_cie'];?></td>
                    <td><?php echo $row['enviromentalstudies_theory_ese'];?></td>
