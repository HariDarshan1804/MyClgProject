<?php
  ...
  if (isset($_POST['update'])) 
  {
    ...
    $qurey = "update tbl_footer_feane set icon='".$icon."',link='".$link."',edit_date='".$edit_date."',edit_by='".$edit_by."' where id='".$_GET['id']."'";
    $finel = mysqli_query($connect,$qurey);

    header('location:footer_feane_list.php');
  }

  $display = "select * from tbl_footer_feane where id='".$_GET['id']."'";
  ...
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Footer Feane Edit</h1>
          </div>
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="#">Home</a></li>
              <li class="breadcrumb-item active">Footer Feane Edit</li>
            </ol>
          </div>
        </div>
      </div><!-- /.container-fluid -->
