        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <?php 
                    $counter = 1;
                    $qurey = "Select* from student_result_sem4 where id='". $_SESSION['admin_id']."'";
              ...
              <div class='row'>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <td>Software Engineering</td> 
                    <td><?php echo $row['software_engineering_theory_cie'];?></td>
                    <td><?php echo $row['software_engineering_theory_ese'];?></td>
                    
                    <td><?php echo $row['total_grade_1'];?></td>
                   
                    <td><?php echo $row['software_engineering_practical_cie'];?></td>
                    <td><?php echo $row['software_engineering_practical_ese'];?></td>
                  ...
                  <td>Cloud Computing</td> 
                    <td><?php echo $row['cloud_computing_theory_cie'];?></td>
                    <td><?php echo $row['cloud_computing_theory_ese'];?></td>
                    
                    <td><?php echo $row['total_grade_2'];?></td>
                   
                    <td><?php echo $row['cloud_computing_practical_cie'];?></td>
                    <td><?php echo $row['cloud_computing_practical_ese'];?></td>
                  ...
                  <td>Electrical Technology</td> 
                    <td><?php echo $row['electrical_technology_theory_cie'];?></td>
                    <td><?php echo $row['electrical_technology_theory_ese'];?></td>
                    
                    <td><?php echo $row['total_grade_3'];?></td>
                    <td><?php echo $row['electrical_technology_practical_cie'];?></td>
                    <td><?php echo $row['electrical_technology_practical_ese'];?></td>
                  ...
                  <tr>
                  <td>Adv Chemistry</td> 
                    <td><?php echo $row['adv_chemistry_theory_cie'];?></td>
                    <td><?php echo $row['adv_chemistry_theory_ese'];?></td>
                    
                    <td><?php echo $row['total_grade_4'];?></td>
                    <td><?php echo $row['adv_chemistry_practical_cie'];?></td>
                    <td><?php echo $row['adv_chemistry_practical_ese'];?></td>
                    <td><?php echo $row['total_grade_8']; ?></td>
                    <td><?php echo $row['subject_grade_8']; ?></td>
