          ...
          <div class="col-12">
            <div class="card">
              ...
              <?php 
                    ...
                    $qurey = "Select * from student_result_sem1 where id='". $_SESSION['admin_id']."'" ;
              ...
              <div class='row'>
                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tr>
                  <td>Chemistry</td> 
                    <td><?php echo $row['chemistry_theory_cie'];?></td>
                    <td><?php echo $row['chemistry_theory_ese'];?></td>
                    
                    <td><?php echo $row['total_grade_2'];?></td>
                    <td><?php echo $row['chemistry_practical_cie'];?></td>
                    <td><?php echo $row['chemistry_practical_ese'];?></td>
                    <td><?php echo $row['total_grade_5']; ?></td>
                    <td><?php echo $row['subject_grade_2']; ?></td>   
                  </tr>
                 
                  
                  <tr>
                  <td>Physics</td> 
                    <td><?php echo $row['physics_theory_cie'];?></td>
                    <td><?php echo $row['physics_theory_ese'];?></td>
                    
                    <td><?php echo $row['total_grade_3'];?></td>
                    <td><?php echo $row['physics_practical_cie'];?></td>
                    <td><?php echo $row['physics_practical_ese'];?></td>
                  ...
                  <tr>
                  <td>Maths</td> 
                    <td><?php echo $row['maths_theory_cie'];?></td>
                    <td><?php echo $row['maths_theory_ese'];?></td>
                    ...
                    <td>-</td>
                    <td>-</td>
                    <td><?php echo $row['subject_grade_3']; ?></td>
